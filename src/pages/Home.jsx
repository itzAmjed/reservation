        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center mb-12">
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-8 animate-slide-up">
              Experience unparalleled luxury at handpicked destinations. 
          ...
          <div className="flex items-end justify-between mb-12">
            <div>
              ...
              <p className="text-muted-foreground max-w-xl">
                Handpicked luxury properties offering exceptional experiences
              </p>
            </div>
            <Link to="/search">
      ...
      <section className="py-20 bg-card border-y border-border">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-muted-foreground max-w-xl mx-auto mb-8">
            Let our travel experts craft your perfect luxury escape
          </p>
          <Link to="/contact">
