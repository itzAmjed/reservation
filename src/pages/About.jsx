        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              Founded with a passion for exceptional travel experiences, Aurelia Travel has grown 
              from a boutique agency to a globally recognized luxury travel curator. We believe 
              that travel should be transformative, creating memories that last a lifetime.
            </p>
            <p className="text-muted-foreground leading-relaxed">
              Our team of expert travel consultants personally visit every property we recommend, 
              ensuring that only the finest establishments earn a place in our collection.
            </p>
          </div>
        </div>
      </section>
